 ...
 */
public class TriangleColor extends GeometricObjectColor implements Colorable {
	...
	public TriangleColor(double side1, double side2, double side3) {
		this.side1 = side1;
		this.side2 = side2;
		this.side3 = side3;
	}
	...
	//Creates a string to describe how to color the triangle
	@Override
